...
class CustomSearchableDropdowntth<T> extends StatefulWidget {
  final String? label;
  ...
  const CustomSearchableDropdowntth.multiSelect({
    Key? key,
  ...
  const CustomSearchableDropdowntth({
    Key? key,
  ...
  @override
  CustomSearchableDropdowntthState<T> createState() => CustomSearchableDropdowntthState<T>();
}

class CustomSearchableDropdowntthState<T> extends State<CustomSearchableDropdowntth<T>> {
                      ...
                      Builder(builder: (context) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            //  boxShadow: [BoxShadow(color: Colors.white,spreadRadius: 2,blurRadius: 200)],
                            ...
                            border: Border.all(color: Theme.of(context).dividerColor)//width: 4.5,
                          ),

                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Icon(MaterialCommunityIcons.home_group,  size: MediaQuery.of(context).size.height * 0.032,
                                  color:Color(0xFF00485f),),
                              Text(title ?? "Select Ward",style: TextStyle(fontSize: 20,color: Colors.black.withOpacity(0.4)),),
                              Align(
