...
class CustomSearchableDropdownone<T> extends StatefulWidget {
  final String? label;
  ...
  const CustomSearchableDropdownone.multiSelect({
    Key? key,
  ...
  const CustomSearchableDropdownone({
    Key? key,
  ...
  @override
  CustomSearchableDropdownoneState<T> createState() => CustomSearchableDropdownoneState<T>();
}

class CustomSearchableDropdownoneState<T> extends State<CustomSearchableDropdownone<T>> {
                      ...
                      Builder(builder: (context) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                             // boxShadow: [BoxShadow(color: Colors.white,spreadRadius: 0,blurRadius: 500)],
                             color: Colors.white,
                            //boxShadow: ,
                           // color:Color(0xA600485f).withOpacity(0.2),
                            borderRadius: BorderRadius.circular(10.0),
                            border: Border.all( color: Theme.of(context).dividerColor)//width2
                          ),

                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Icon(MaterialCommunityIcons.christianity_outline,  size: MediaQuery.of(context).size.height * 0.032,
                                  color:Color(0xFF00485f),),
                              Text(title ?? "Select Diocese",style: TextStyle(fontSize: 20,color: Colors.black.withOpacity(0.4)),),
                              Align(
